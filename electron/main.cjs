...
function runMigrations() {
  ...
  try {
    ...
    // === HR TABLES (disciplinary, terminations, salary adjustments, loans, attendance, audit) ===
    db.exec(`
      CREATE TABLE IF NOT EXISTS disciplinary_records (
        id TEXT PRIMARY KEY,
        employee_id TEXT NOT NULL,
    ...
    `);
    console.log('Migration: Ensured disciplinary_records table exists');
    ...
    `);
    console.log('Migration: Ensured terminations table exists');
    ...
    `);
    console.log('Migration: Ensured salary_adjustments table exists');
    ...
    `);
    console.log('Migration: Ensured loans table exists');
    ...
    `);
    console.log('Migration: Ensured loan_payments table exists');
    ...
    `);
    console.log('Migration: Ensured attendance table exists');
